 ...
 * @author asus
 */
public class Info_Page_new extends javax.swing.JFrame {

    /**
     * Creates new form Info_Page_new
     */
    public Info_Page_new() {
        initComponents();
    }
    ...
    private void rentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rentActionPerformed
        ...
        try{
          Rent_Success rs = new Rent_Success();  
//          this.setVisible(false);
    ...
    private void likeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_likeActionPerformed
        ...
        System.out.println("跳转到成功/失败页面");
         try{
          Like_Success ls = new Like_Success();  
          ls.setVisible(true);
        }catch(Exception e){
...
//                    UIManager.setLookAndFeel(lookAndFeel);
            ...
            java.util.logging.Logger.getLogger(Info_Page_new.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Info_Page_new().setVisible(true);
            }
        });
    }
